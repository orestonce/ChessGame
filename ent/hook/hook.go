...
// Mutate calls f(ctx, m).
func (f DRoomFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.DRoomMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DRoomMutation", m)
	}
	return f(ctx, mv)
}

// The DSessionFunc type is an adapter to allow the use of ordinary
// function as DSession mutator.
type DSessionFunc func(context.Context, *ent.DSessionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DSessionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.DSessionMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DSessionMutation", m)
	}
	return f(ctx, mv)
}

// The DUserFunc type is an adapter to allow the use of ordinary
// function as DUser mutator.
type DUserFunc func(context.Context, *ent.DUserMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DUserFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.DUserMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DUserMutation", m)
	}
	return f(ctx, mv)
}
